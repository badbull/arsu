define({ "api": [
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "favourites",
            "description": "<p>List of favourite items.</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
      ...
      "fields": {
        "Success 201": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Id of the created favourite item.</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "description": "<p>Deletes a history entry of the authenticated user.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Id of the history entry.</p>"
          }
        ]
      }
    },
    ...
    "filename": "src/routes/history.routes.js",
    "groupTitle": "History"
  },
  {
    "type": "get",
    "url": "/history",
    "title": "Request a list of history entries",
    "version": "0.2.0",
    "name": "GetCurrentUserHistory",
    "group": "History",
    "permission": [
      {
        "name": "token",
    ...
    "description": "<p>Request a list of podcast history by authenticated user.</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "history",
            "description": "<p>List of history items.</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
      ...
      "fields": {
        "Success 201": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Id of the created history entry.</p>"
          }
        ]
      },
      "examples": [
